...
export const CloudflareDeployContent = ({
  ...
  const deployToMainDomain = async () => {
    ...
    try {
      ...
      if (res.data.ok) {
        toast.success(`Website deployed successfully to main domain! Available at: https://ai.9gent.com`);

        // Open the deployed website in a new tab
        window.open("https://ai.9gent.com", '_blank');
    ...
    <>
      ...
      <main className="space-y-4 p-6">
        ...
        <div className="space-y-3">
          ...
          >
            Publish to ai.9gent.com <Star className="size-4 ml-2" />
